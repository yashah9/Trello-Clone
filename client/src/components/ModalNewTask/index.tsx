...
type Props = {
  isOpen: boolean;
  onClose: () => void;
  id?: string | null; // This is the project ID
};
...
const ModalNewTask = ({ isOpen, onClose, id = null }: Props) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await createTask({
        ...
        projectId: parseInt(id, 10), // Ensure `id` is passed as an integer
      });
  ...
  const isFormValid = () => title && authorUserId && id;
